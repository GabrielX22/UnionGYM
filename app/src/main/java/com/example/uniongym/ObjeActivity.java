...
public class ObjeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_obje); // Establece el diseño de la actividad
        ...
        btnSaveGoals.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!selectedGoals.isEmpty()) {
                    ...
                    Toast.makeText(ObjeActivity.this, goalsText, Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(ObjeActivity.this, "Selecciona al menos un objetivo", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
